<template>
  <div class="about pt-4 w-96 mx-auto">
    ...
    <p class="paragraph">
      ...
      strings, where you have doubts about whether something is possible or recommendable. Some of
      those questions can be solved with the tools provided here so that you can reduce the nagging
      of string players!
    </p>
    <p class="paragraph">
